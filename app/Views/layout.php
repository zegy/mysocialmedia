...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed"><!-- options: sidebar-collapse / sidebar-mini -->
  <div class="wrapper">
      ...
      <div class="sidebar"><!-- Sidebar -->
        ...
        <nav class="mt-2"><!-- Sidebar Menu -->
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="<?= base_url('group/umum/group_posts') ?>" class="nav-link" id="umum">
            ...
            <li class="nav-item">
              <a href="<?= base_url('group/test/group_posts') ?>" class="nav-link" id="test">
                <i class="nav-icon fas fa-th"></i>
                <p>
                  Test
                  <!-- <span class="right badge badge-danger">1</span> -->
    ...
    <aside class="view-modal"></aside> <!-- TODO Experimental : Use "aside"? -->
