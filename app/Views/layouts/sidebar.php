          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class=""><a class="nav-link" href="">Ecommerce Dashboard</a></li>
              </ul>
            </li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class=""><a class="nav-link" href="">Default Layout</a></li>
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li class=""><a class="nav-link" href="">Alert</a></li>
                <li class=""><a class="nav-link" href="">Badge</a></li>
              </ul>
            </li>
          </ul>
