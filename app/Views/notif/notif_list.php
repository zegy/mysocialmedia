  ...
  <div class="media"><!-- Message Start -->
    ...
    <div class="media-body">
      <h3 class="dropdown-item-title">
        ...
        <span class="float-right text-sm text-danger"><?php if ($notif->notif_type == 'comment') {echo('Komentar');} else {echo('Komentar');} ?></span> <!-- NOTE The custom -->
      </h3>
      <p class="text-sm"><?php if ($notif->notif_type == 'comment') {echo('telah mengomentari postingan anda!');} else {echo('mengomentari postingan yang anda ikuti!!');} ?></p>
