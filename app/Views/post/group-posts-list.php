  ...
  <table style="text-align: center" class="table table-head-fixed text-wrap projects"> <!-- TODO : Clean "projects" later -->
    ...
    <tbody>
      ...
      <tr>
        ...
        <td style="min-width: 330px; max-width: 330px; text-align: justify"><a href="<?= base_url('group/umum/group_post_detail/' . $post->pid) ?>"><?= $post->pttl ?></a></td> <!-- NOTE Experimental : The weird "style" is so table's column can have "static" width -->
